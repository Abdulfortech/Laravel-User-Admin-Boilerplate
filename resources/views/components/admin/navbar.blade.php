    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="{{route('admin.dashboard')}}">Home</a></li>
      ...
      <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
        ...
        <ul class="navbar-nav  justify-content-end">
          ...
          <li class="nav-item pe-2 mx-2 d-flex align-items-center">
            <a href="{{route('admin.products.add')}}" class="nav-link text-white font-weight-bold px-0" aria-expanded="false">
              <span class="d-sm-inline badge bg-white text-primary d-none" id="caption-title">
                <i class="fa fa-plus me-sm-1" style="font-size: 15px;"></i> Product</span>
            </a>
          </li>
