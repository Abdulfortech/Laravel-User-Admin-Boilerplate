<aside class="sidebar sidebar-default sidebar-mini sidebar-white sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="index" class="navbar-brand">
            <!--Logo start-->
            <div class="logo-main">
                <div class="logo-normal">
                    <img src="{{ asset('app/assets/images/logos/aarasheeddata2.png') }}" width="100" height="50">
                </div>
                <div class="logo-mini">
                    <img src="{{ asset('app/assets/images/logos/aarasheeddata2.png') }}" width="100" height="50">
                </div>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled d-flex align-items-center justify-content-center" href="#" tabindex="-1">
                        <span class="default-icon text-center">
                            <center>
                                <i class="fa fa-user-circle text-primary" style="font-size: 50px"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ ($page == 'wallet') ? 'active' : '' }}" aria-current="page" href="wallet">
                        <i class="fa fa-piggy-bank"></i>
                        <span class="item-name">Wallet</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo ($page == 'wallet-topup') ? 'active' : ''; ?>" aria-current="page" href="wallet-topup">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo ($page == 'buy-data-card') ? 'active' : ''; ?>" aria-current="page" href="{{route('user.buyDataCard')}}">
                        <i class="fa fa-wifi"></i>
                        <span class="item-name">Buy Data Card</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo ($page == 'buy-electricity') ? 'active' : ''; ?>" href="{{route('user.buyElectricity')}}" aria-current="page">
                        <i class="fa fa-plug"></i>
                        <span class="item-name">Buy Electricity</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                {{-- 
                <li class="nav-item">
                    <a class="nav-link <?php echo ($page == 'buy-education') ? 'active' : ''; ?>" href="buy-education" aria-current="page">
                        <i class="fa fa-book"></i>
                        <span class="item-name">Buy Education Pin</span>
                    </a>
                </li> --}}
                {{-- <li class="nav-item">
                    <a class="nav-link <?php echo ($page == 'airtime-cash') ? 'active' : ''; ?>" href="airtime-cash" aria-current="page">
                        <i class="fa fa-phone-square"></i>
                        <span class="item-name">Airtime to Cash</span>
                    </a>
                </li> --}}
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
