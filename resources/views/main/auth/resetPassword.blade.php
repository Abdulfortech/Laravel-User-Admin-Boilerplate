                    ...
                    <div class="col-md-10">
                        <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                            <div class="card-body">
                                ...
                                <form id="login-form" action="{{ route('user.resetPassword') }}" method="POST">
                                    @csrf
                                    <h2 class="mb-2">Reset Password</h2>
                                        <p>Provide a new password to finish reseting the password.
                                        </p>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" id="confirm-password" aria-describedby="confirm-password" placeholder=" ">
                                                    <div id="passwordError2" class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" class="btn btn-primary col-12" id="submitButton">Reset</button>
                                            </div>
                                            <p class="mt-3 text-center">
                                                Changed your mind? <a href="{{route('user.login')}}" class="text-underline">Login instead</a>
                                            </p>
                                        </div>
                                </form>
                            </div>
