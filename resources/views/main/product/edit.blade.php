...
@section('title', 'OneStop | Edit Vendor')
@php( $page = 'vendor')
@section('contents')
                ...
                <div class="card-body text-center align-items-center">
                    <div id="stepperForm" class="bs-stepper">
                        ...
                        <div class="bs-stepper-content">
                            <form class="needs-validation text-left" action="{{route('vendor.update', [$vendor->id])}}" method="POST" novalidate>
                                @csrf
                                ...
                                <div id="test-form-1" role="tabpanel" class="bs-stepper-pane fade align-items-start text-start" aria-labelledby="stepperFormTrigger1">
                                    ...
                                    <div class="form-group align-items-start mb-2">
                                        ...
                                        <input id="businessName" name="name" value="{{$vendor->name}}" type="text" class="form-control" placeholder="Enter business Name" required>
                                        @error('name')
                                    ...
                                    <div class="form-group align-items-start row">
                                        <div class="col-md-7 mb-2">
                                            ...
                                            <input id="motto" type="text" value="{{$vendor->motto}}" name="motto" class="form-control" placeholder="Enter business Motto" required>
                                            @error('motto')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group align-items-start mb-2">
                                        ...
                                        <textarea name="description" id="businessDesc" class="form-control" rows="4" placeholder="Describe Your Business" required>{{$vendor->description}}</textarea>
                                        @error('description')
                                            <span class="text-danger small">{{ $message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div id="test-form-2" role="tabpanel" class="bs-stepper-pane fade align-items-start text-start" aria-labelledby="stepperFormTrigger2">
                                    ...
                                    <div class="form-group align-items-start row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input id="businessPhone1" value="{{$vendor->phone1}}" name="phone1" type="text" class="form-control" placeholder="Enter phone number 1" required>
                                            @error('phone1')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input id="businessPhone2" value="{{$vendor->phone2}}" name="phone2" type="text" class="form-control" placeholder="Enter phone number 2">
                                            @error('phone2')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input id="businessEmail" value="{{$vendor->email}}" name="email" type="email" class="form-control" placeholder="Enter email">
                                            @error('email')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input id="businessWebsite" value="{{$vendor->website}}" name="website" type="text" class="form-control" placeholder="Enter website">
                                            @error('website')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input id="businesslga" value="{{$vendor->lga}}" name="lga" type="text" class="form-control" placeholder="Enter LGA you operate">
                                            @error('lga')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <input id="address" value="{{$vendor->address}}" name="address" type="text" class="form-control" placeholder="Enter business address" required>
                                            @error('address')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                ...
                                <div id="test-form-3" role="tabpanel" class="bs-stepper-pane fade align-items-start text-start" aria-labelledby="stepperFormTrigger3">
                                    ...
                                    <div class="form-group align-items-start row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input id="facebook" value="{{$vendor->whatsapp}}" name="whatsapp" type="number" class="form-control" placeholder="Enter Whatsapp Number">
                                            @error('whatsapp')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input id="facebook" value="{{$vendor->instagram}}" name="instagram" type="text" class="form-control" placeholder="Enter Instagram Page Link">
                                            @error('instagram')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <input id="facebook" value="{{$vendor->facebook}}" name="facebook" type="text" class="form-control" placeholder="Enter Facebook Page Link">
                                            @error('facebook')
                                                <span class="text-danger small">{{ $message}}</span>
                                            @enderror
                                        </div>
