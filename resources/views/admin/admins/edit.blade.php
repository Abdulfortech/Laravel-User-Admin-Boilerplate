            ...
            <div class="col-md-8 mx-auto">
              <div class="card mb-4">
                ...
                <div class="card-body pt-0 pb-2">
                    <form id="addClientForm" action="{{route('admin.edit', [$admin->id])}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">First Name</label>
                                    <input class="form-control" name="firstName" value="{{$admin->firstName}}" type="text" required>
                                    @error('firstName')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="lastName" value="{{$admin->lastName}}" type="text" required>
                                    @error('lastName')
                                    <span class="text-danger small">{{ $message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="username" value="{{$admin->username}}" type="text" readonly>
                                    @error('username')
                                    <span class="text-danger small">{{ $message}}</span>
                                    @enderror
                                </div>
