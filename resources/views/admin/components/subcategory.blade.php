                ...
                <div class="card">
                  <div class="card-header pb-0">
                    <div class="d-flex align-items-center ">
                      <h4 class="mb-0 fw-bold">Sub Categories</h4>
                      <a data-bs-toggle="modal" data-bs-target="#addCategoryModal" class="btn btn-primary btn-sm ms-auto"> <i class="fa fa-plus"></i> Sub Category</a>
                    </div>
                  </div>
                  <div class="card-body">
                      <div class="table-responsive p-0">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.subcategoryDelete',[$subcategory->id])}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @php($count++)
                            @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addLgaForm" action="{{route('admin.addSubcategory')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
