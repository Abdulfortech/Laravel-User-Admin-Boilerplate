                ...
                <div class="card">
                  <div class="card-header pb-0">
                    <div class="d-flex align-items-center ">
                      ...
                      <a data-bs-toggle="modal" data-bs-target="#addBrandModal" class="btn btn-primary btn-sm ms-auto"> <i class="fa fa-plus"></i> Brand</a>
                    </div>
                  </div>
                  <div class="card-body">
                      <div class="table-responsive p-0">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$brand->status}}</td>
                                <td>
                                    <a href="{{route('admin.brandDelete',[$brand->id])}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @php($count++)
                            @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addLgaForm" action="{{route('admin.addBrand')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
