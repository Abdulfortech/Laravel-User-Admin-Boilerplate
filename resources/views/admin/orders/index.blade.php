                ...
                <table class="table align-items-center mb-0" id="datatable">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary font-weight-bolder">Sub Total</th>
                  ...
                  <tbody>
                    @php($count = 1)
                      ...
                      <tr>
                          ...
                          <td><span class="badge bg-info p-1">{{$Order->paymentStatus}}</span></td>
                          <td>
                            <a href="{{route('admin.orders.view',[$Order->id])}}" class="btn btn-primary btn-sm p-2"><i class="fa fa-eye"></i></a>
