        ...
        <div class="col-md-9 mx-auto">
          <div class="card mb-4">
            <div class="card-header text-center pb-0">
                    <img src="{{ $product->image1 }}" class="rounded-circle" alt="employee-image" width="100" height="100">
              <h4 class="text-center">Edit Product</h4>
            </div>
            <div class="card-body px-2 pt-0 pb-2">
                <form id="addProductForm" enctype="multipart/form-data" action="{{route('admin.products.update', [$product->id])}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Title</label>
                                <input class="form-control" name="title" id="addProductName" value="{{$product->title}}" type="text" required>
                                @error('title')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="normal_price" value="{{$product->normal_price}}" id="addProductPrice" required>
                                @error('normal_price')
                                <span class="text-danger small">{{ $message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="price" value="{{$product->price}}" id="addProductPrice" required>
                                @error('price')
                                <span class="text-danger small">{{ $message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_desc" id="addProductStock" maxlength="250" required>{{$product->short_desc}}</textarea>
                                @error('short_desc')
                                <span class="text-danger small">{{ $message}}</span>
                                @enderror
                            </div>
